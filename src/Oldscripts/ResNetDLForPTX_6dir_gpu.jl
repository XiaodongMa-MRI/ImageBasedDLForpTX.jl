...
model = cpu(r)
BSON.@save string("Results/model_resnet_ptx_processed_7Vol_gpu_epoch30.bson") model

BSON.@load string("Results/model_resnet_ptx_processed_7Vol_gpu_epoch30.bson") model
...
file = matopen("Results/XValidOutput_subj5_processed_7Vol_gpu_resnet_epoch30.mat", "w")
